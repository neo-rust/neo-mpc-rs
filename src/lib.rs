...
fn same_ratio<G: PairingCurveAffine>(g1: (G, G), g2: (G::Pair, G::Pair)) -> bool {
...
fn keypair<R: RngCore>(rng: &mut R, current: &MPCParameters) -> (PublicKey, PrivateKey) {
    // Sample random delta
